...
% Conservative shave: pulls prose into one-table-one-figure-per-page
% layouts (e.g. K-ablation table+figure pages) without changing global
% look-and-feel. Closed by the matching \endgroup at end of file.
\begingroup
% Stage 1: glue around floats
...
\setlength{\@fpsep}{6pt plus 0fil}
\setlength{\@fpbot}{0pt plus 1fil}
\makeatother
% Stage 2: float-placement fractions (allow more float per page; require less surrounding text)
\renewcommand{\topfraction}{0.95}        % up from 0.70 — a top float can occupy 95\% of a page
\renewcommand{\bottomfraction}{0.95}     % up from 0.30
\renewcommand{\textfraction}{0.05}       % down from 0.20 — minimum prose around floats
\renewcommand{\floatpagefraction}{0.80}  % up from 0.50 — float-only pages must be 80\% full
\renewcommand{\dbltopfraction}{0.95}
\renewcommand{\dblfloatpagefraction}{0.80}
% Stage 3: allow more floats per page
\setcounter{topnumber}{4}                 % up from 2
\setcounter{bottomnumber}{4}              % up from 1
\setcounter{totalnumber}{8}               % up from 3
