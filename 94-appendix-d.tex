...
This appendix provides supplementary ablation results that support Chapter~\ref{chap:results}. All reported values are tied to retained public artefacts. The complete OOD detection results (including FPR@TPR95) are presented in the main text (Table~\ref{tab:results:main-auroc}).
