...
\begin{table}[htbp]
  \centering
  \caption{$K$ ablation: AUROC (\%) and relative inference cost on within-CIFAR split. Reference cost is the discriminative baseline (ResNet-18 forward pass) measured on an NVIDIA GeForce RTX 2080 Ti.}
