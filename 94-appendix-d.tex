...
This appendix provides supplementary ablation results that support Chapter~\ref{chap:results}. Core claims are tied to recoverable artefacts; archived values are kept only as supplementary context. The complete OOD detection results (including FPR@TPR95) are presented in the main text (Table~\ref{tab:results:main-auroc}).
