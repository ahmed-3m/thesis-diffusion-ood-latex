...
source-image groups; all crops from the same source image stay in the
same fold, preventing leakage. Separation-loss ablation trains the CDM
with $\lambda \in \{0.0, 0.01, 0.02, 0.05\}$ to evaluate whether the
