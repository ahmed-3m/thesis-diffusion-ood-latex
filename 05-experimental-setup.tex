...
STL-10~\citep{coates2011analysis} (8,000 images, resized to
$32 \times 32$, overlapping classes with CIFAR-10).

\textbf{Far-OOD: Food-101}~\citep{bossard2014food} (25,250 images, resized to
$32 \times 32$); SVHN~\citep{netzer2011reading} (26,032 digit images,
...
Under the public-evidence protocol, core external claims use the five datasets
...
supplementary archived entries only.
...
final reproducibility report, core claims are restricted to results with
...
FPR@95\%TPR are reported for reproducible raw-score runs. Datasets without
recoverable current raw-score tensors are treated as supplementary
archived entries and excluded from core claims. Importantly, no
